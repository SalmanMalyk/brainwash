        ...
        <div class="row row-grid align-items-center">
          ...
          >
            ...
            <p
              ...
              v-if="
                $store.state.fakeScreen === null ||
                  $store.state.fakeScreen === ''
              "
            >
              Please upload your wallpaper below
            </p>
            <p
              class="lead text-white"
              style="padding: 0px 10px 10px 10px;"
          ...
          >
            <card
              shadow
              class="card-bg shadow-lg--hover mt-2 "
              v-if="
                $store.state.fakeScreen === null ||
                  $store.state.fakeScreen === ''
              "
            >
              ...
              >
                <base-button
                  ...
                  @click="changeMode"
                  class="mb-3"
                  style="min-width: 13rem!important; margin-left: 8px;"
                  >Switch to
                  {{ this.$store.state.mode === "ios" ? "Android" : "IOS" }}
                  Mode</base-button
                >
                <file-selector
                ...
                >
                  <base-button
                    type="primary"
                    style="min-width: 13rem!important;"
                    >Select wallpaper</base-button
                  >
                </file-selector>
                ...
                <base-button
                  type="primary"
                  @click="alignAudioPlayer"
                  class="mb-3"
                  style="min-width: 13rem!important; margin-left: 8px;"
                  >Align Player</base-button
                >
            ...
            <card shadow class="card-bg shadow-lg--hover mt-2" v-else>
              ...
              >
                ...
                <base-button
                  ...
                  @click="alignAudioPlayer"
                  class="mb-3"
                  >Align Audio Player</base-button
                >
                <base-button type="primary" @click="cropFakeScreen" class="mb-3"
                  >Crop wallpaper</base-button
                >
                <base-button
                  type="primary"
                  @click="deleteFakeScreen"
                  class="mb-3"
                  >Delete wallpaper</base-button
                ><br />
