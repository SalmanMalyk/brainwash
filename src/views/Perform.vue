  ...
  <v-touch @swipedown="swipeBottomHandler" :swipe-options="{ threshold: 200 }">
    ...
    <div style="width: 100vw">
        ...
        <div v-if="mode === 'ios'" class="row">
          <div
            ...
            :style="{
              ...
              backgroundImage:
                'url(' +
                ($store.state.fakeScreen === ''
                  ? $store.state.fakeScreenDefaultIOS
                  : $store.state.fakeScreen) +
                ')',
            }"
          >
            <div class="clock">
              <div class="position-relative text-center">
                <img
                  style="
                    margin: 1rem auto 1.3rem auto !important;
                    height: 2.3rem;
                  "
                ...
                <p class="date" style="font-weight: 100 !important">
                  {{ date }}
                </p>
              </div>
            </div>
            ...
            <div
              ...
              style="position: absolute; z-index: 2 !important"
            >
              <div
                class="position-relative text-center"
                :style="{
                  width: windowWidth + 'px',
                  top: $store.state.top + 'px!important',
                }"
              >
                <VueAudioFake
            ...
            <div
              ...
              :style="{
                ...
                backgroundImage:
                  'url(' +
                  ($store.state.fakeScreen === ''
                    ? $store.state.fakeScreenDefaultAndroid
                    : $store.state.fakeScreen) +
                  ')',
              }"
            ></div>
      ...
      <div v-else-if="step === 3">
        <v-touch
          @swipe="chooseCardNumber((13).toString())"
          :swipe-options="{ threshold: 150, pointers: 2 }"
        >
          <div class="row" v-for="row in [1, 4, 7, 10]" :key="row">
            <div
              @click="chooseCardNumber((row + col).toString())"
              v-for="col in range(3)"
              class="col-4"
  ...
  methods: {
    ...
    async playSound() {
      const audioBuffer = await load(
        this.voiceData[this.cardType][this.cardNumber]
      );
